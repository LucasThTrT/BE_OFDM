...
% Ajout de l'intervalle de garde sur 4 porteuses en plus
% on ajoute 4 veteurs de taille n/N = taille monoporteuse
mat_OFDM = [zeros(4, n/N); symboles_OFDM];  % Ajout en tête des porteuses !!
...
% On enlève les 4 premières "porteuses" qui sont l'ajout de l'IG
